...
public static class VectorToolkits {
	...
	static public Vector3 getEndVector3(Vector3 directionalFrom, Vector3 directionalTo, Vector3 from, float toDistance)
	{
		Vector3 diff = directionalTo - directionalFrom;
		return diff.normalized * toDistance + from;
	}
